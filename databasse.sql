create database db;
use db;
create table user( user_id int auto_increment, primary key(user_id), name varchar(255), email varchar(255), password varchar(255), phone int);
create table admin( email varchar(255), primary key(email), password varchar(255));
create table event_category( category varchar(255) unique);
create table organizer(organizer_id int auto_increment, primary key(organizer_id), name varchar(255), email varchar(255) unique, password varchar(255), phone int);
